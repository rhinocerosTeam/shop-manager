...
(function() {
    ...
    window.onload = function() {
        ...
        if(window.location.hostname == 'server.huayi-art.com'){
            var imgHostUrl = 'http://api.huayi-art.com/pub/v1/getAliOssUploadCfg';
        }else{
            var imgHostUrl = 'http://devapi.huayi-art.com/pub/v1/getAliOssUploadCfg';
        }
    ...
    //   var imgHostUrl = 'http://devapi.huayi-art.com/pub/v1/getAliOssUploadCfg' ;
        $.ajax({
                ...
                dataType: 'json',
                data: {
                  data : JSON.stringify({uploadCfg:1})
                },
            })
            .done(function(data) {
                res = {
    ...
    UploadImage.prototype = {
        ...
        initUploader: function() {
            ...
            uploader = _this.uploader = WebUploader.create({
                ...
                server: 'http://img.huayi-art.com/',
                fileVal: editor.getOpt('imageFieldName'),
                duplicate: true,
                fileSingleSizeLimit: null , // imageMaxSize 默认 2 M
            ...
            uploader.on('all', function(type, files) {
                switch (type) {
                    ...
                    case 'startUpload':
                        ...
                        uploader.option('server', 'http://img.huayi-art.com/');
            ...
            uploader.on('uploadBeforeSend', function(file, data, header) {
                ...
                data.host = 'http://img.huayi-art.com/';
                data.server = 'http://img.huayi-art.com/';
                data.key = data.dir + data.name;
            ...
            uploader.on('uploadSuccess', function(file, ret) {
                var $file = $('#' + file.id);
                var json = 'http://img.huayi-art.com/' + res.dir + file.name;
                _this.imageList.push(json);
                console.log('json', _this.imageList)
